...
WEAVIATE_CLUSTER_URL = os.getenv('WEAVIATE_CLUSTER_URL') or 'https://grpc-9tm0fahhstiktrd58gurww.c0.us-west3.gcp.weaviate.cloud'
WEAVIATE_API_KEY = os.getenv('WEAVIATE_API_KEY') or '8Wtg7EXkAeC7sKwkB3AVuMRDHKAQF0J1Y2mC'
